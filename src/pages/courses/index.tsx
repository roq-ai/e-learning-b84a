...
export function CourseListPage(props: CourseListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getCourses({
        relations: ['user', 'practice_test_result.count', 'question.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('practice_test_result', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'practice_test_result',
          header: 'Practice Test Result',
          accessorKey: 'practice_test_result',
          cell: ({ row: { original: record } }: any) => record?._count?.practice_test_result,
        }
      : null,
