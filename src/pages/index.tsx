  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to e-learning: Empowering Students with Comprehensive Courses, Tailored Practice Tests, and Personalized Learning Paths. Your Journey to Success Starts Here."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1501504905252-473c47e087f8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxlLWxlYXJuaW5nfGVufDB8fHx8MTY5MTEzNzQ5NXww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to e-learning: Empowering Students with Comprehensive Courses, Tailored Practice Tests, and Personalized Learning Paths. Your Journey to Success Starts Here.`}
            </Text>
            <Box
